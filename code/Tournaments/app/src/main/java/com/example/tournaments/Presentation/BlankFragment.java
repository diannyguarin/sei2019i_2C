...
/*
    ...
    public ArrayList<Tournament> getTournaments(){
        ...
        try{
            ...
            Toast.makeText(getActivity().getApplicationContext(), "Paila prro", Toast.LENGTH_SHORT).show();
        }
        return tournaments;
    }

    public void populateTournamentList(){
        TournamentsAdapter tournamentsAdapter = new TournamentsAdapter(getActivity().getApplicationContext(), getTournaments());
