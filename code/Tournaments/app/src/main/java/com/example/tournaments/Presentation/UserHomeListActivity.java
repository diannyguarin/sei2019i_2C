...
public class UserHomeListActivity extends Prueba {
    ...
    public void populateTournamentList(){
        ...
        tournamentsAdapter = new TournamentsAdapter(UserHomeListActivity.this, populateTournamentListController.getTournaments());
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                try{
                    ...
                    Intent intent3 = new Intent(UserHomeListActivity.this, Teams_Check_Activity.class);
                    intent3.putExtra("idTournament", tournamentsAdapter.getItem(position).getId_torneo());
    ...
    private void deleteItem_Clik() {
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, final View view, final int position, long l) {
                ...
                dialogo1.setMessage("Ã‚Â¿ You want to eliminate this tournament ?");
